...
from Functions import Data, Ada, Create_dir
...
plt.xlabel(r'$\gamma$')
plt.ylabel('$N$')
plt.savefig(PNG_path / 'GD_Ada_gamma_iter')
plt.savefig(PDF_path / 'GD_Ada_gamma_iter.pdf')
...
plt.xlabel(r'$\lambda$')
plt.ylabel('$N$')
plt.savefig(PNG_path / 'GD_Ada_lambda_iter')
plt.savefig(PDF_path / 'GD_Ada_lambda_iter.pdf')
plt.show()